            ...
            <div class="row g-4">
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-light text-center rounded p-4">
                        ...
                        <canvas id="worldwide-sales" width="507" height="253" style="display: block; box-sizing: border-box; height: 224.889px; width: 450.667px;"></canvas>
                    </div>
                </div>
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-light text-center rounded p-4">
                        ...
                        <canvas id="salse-revenue" width="507" height="253" style="display: block; box-sizing: border-box; height: 224.889px; width: 450.667px;"></canvas>
                    </div>
                </div>
            </div>
        </div>
