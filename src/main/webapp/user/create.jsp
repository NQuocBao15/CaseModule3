      ...
      <div class="card container px-6" style="height: 100vh">
        ...
        <form action="/user?action=create" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="tex" class="form-control" id="username" name="username" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <c:forEach var="role" items="${roles}">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="role" id="role${role.id}" value="${role.id}">
