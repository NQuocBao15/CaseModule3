            ...
            <div class="content">
                ...
                <div class="container">
                    <div class="card container px-6" style="height: 100vh">
                        <h3 class="text-center">Management Express</h3>
                        ...
                        <div style="display: flex; align-items: center;">
                            ...
                            <form action="/express?page=${page.currentPage}"
                                  style="display: flex; align-items: center; margin-right: 10px;">
                                <div>
                                    <input type="text" id="searchExpress" value="${search}" name="search"
                                           class="form-control" style="width: 85%" placeholder="Search Express">
                                </div>
