        ...
        <div class="container">
            <form action="/order?action=edit&id=${order.id}" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="idOrder" name="idOrder" value="${order.id}" readonly>
                </div>
                <div class="mb-3">
                    <label for="customer" class="form-label">Customer</label>
                    <input type="text" class="form-control" id="customer" name="customer" value="${order.user.name}" readonly>
                </div>
                <div class="mb-3">
                    <label for="createAt" class="form-label">Create At</label>
                    <input type="date" class="form-control" id="createAt" name="createAt" value="${order.createAt}" readonly>
                </div>
                <div class="mb-3">
                    <label for="nameReceiver" class="form-label">Name Receiver</label>
                    <input type="text" class="form-control" id="nameReceiver" name="nameReceiver" value="${order.nameReceiver}" readonly>
                </div>
                <div class="mb-3">
                    <label for="addressReceiver" class="form-label">Address Receiver</label>
                    <input type="text" class="form-control" id="addressReceiver" name="addressReceiver" value="${order.addressReceiver}" readonly>
                </div>
                <div class="mb-3">
                    <label for="phoneReceiver" class="form-label">Phone Receiver</label>
                    <input type="text" class="form-control" id="phoneReceiver" name="phoneReceiver" value="${order.phoneReceiver}" readonly>
                </div>
                <div class="mb-3">
                    <label for="express" class="form-label">Express</label>
                    <input type="text" class="form-control" id="express" name="express" value="${order.express.name}" readonly>
                </div>
                <div class="mb-3">
                ...
                <div id="order-items" class="row">
                    <c:forEach var="orderItem" items="${order.orderItems}">
                        <div class="col-4">
                            <input type="text" class="form-control" name="product" value="${orderItem.product.name}" readonly>
                        </div>
                        <div class="col-2">
                            <input type="number" class="form-control" name="quantities" value="${orderItem.quantity}" readonly>
                        </div>
                        <div class="col-3">
                            <input type="number" class="form-control" name="price" value="${orderItem.price}" readonly>
                        </div>
                        <div class="col-3">
                            <input type="number" class="form-control" name="price" value="${orderItem.price * orderItem.quantity}" readonly>
                        </div>
                    </c:forEach>
                </div>
